...
\input{content/02_strahlentherapie.tex}
\input{content/03_track_reco.tex}
\input{content/04_simulation_studies.tex}
%\input{content/energy_study.tex}
\input{content/05_xgboost.tex}
\input{content/06_ergebnis.tex}
...
\cleardoublepage
\includepdf[pages=-]{content/eidesstatt.pdf}
