...
\section{Reconstruction of high track density proton beams}\label{sec:density}
...
simulation is increased, while the proton energy is kept constant at $\SI{200}{\mega\eV}$. \\
...
\section{Feature cuts for high track densities}
Tracks inherit numerous features, which characterise them,
for exampleS their deposited energy, the kink angles or their corresponding cluster position on the sensor.
...
Figure \ref{fig:kinks} depicts the kink angles in x- and y-direction for the third and fourth sensor plane divided in the distribution of true and false reconstructed tracks.
...
A ratio of $7329/13604 = 0.538$ of true tracks to the total number tracks is achieved by cutting on smaller values than $\chi^2 = 0.5$,  kink$_{x,3} = 0.004$ and kink$_{x,4}=0.004$. Stronger cuts can create even better ratios with the number of true tracks decreasing significantly. For that reason, the before mentioned
