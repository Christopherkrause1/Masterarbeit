...
as DUTs in between the triplets and an FE-I4 readout chip as a time reference behind the telescope. The RD53A readout chips are
...
smaller than the spatial resolution of the sensor, further indicating a valid track reconstruction for both frameworks. It should be noted that the calculated means and
...
x- and y-direction are shown for the FE-I4 sensor.
