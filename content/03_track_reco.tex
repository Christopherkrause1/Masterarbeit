...
Figure \ref{fig:residualX} depicts the residuals of the first plane in x direction calculated by both frameworks. Three iterations
...
\begin{figure}
  ...
  \end{subfigure}
  \caption{Residual in x direction of the first sensor plane calculated by Corryvreckan on the left and EUTelescope on the right.}
  \label{fig:residualX}
\end{figure}
