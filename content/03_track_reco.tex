...
The generic data acquisition framework EUDAQ \cite{eudaq} records the data produced in testbeam experiments. It centrally handles the data flow and synchronises data stream to enable
