...
residuals on all six planes of the telescope. In order to compare and interpret the $\chi^2$ distributions, each $\chi^2$ value is divided by the number
of degrees of freedom (ndof), which is the ratio of (...). In figure \ref{fig:ndof}, the $\chi^2$ distributions of the reconstructed tracks are shown. \\
Both $\chi^2$ distributions have their maximum around 1.5, further indicating a similar quality of reconstructed tracks.
...
\begin{figure}
  ...
  \end{subfigure}
  \caption{Distributions of the $\chi^2$ value divided by the number of degrees of freedom. Tracks reconstructed with EUTelescope and Corryvreckan
   have eight and seven degrees of freedom, respectively}
  \label{fig:ndof}
\end{figure}
