...
making it possible to control the accuracy and computing time of the simulation. For diffusion simultaions it is necessary to specifiy the temperature of the sensor material
